...
INSERT INTO `site` (`id`, `name`, `qr_url`, `details`, `description`, `latitude`, `longitude`, `district_id`, `points`) VALUES (NULL, 'La Coyotera', NULL, 'Siguiendo el camino de Junquillal a La Cruz, se desvía a la izquierda hacia el Jobo y luego a la derecha hacia el hotel EcoPlaya.',
 'Esta roca se llama conglomerado. Es una roca sedimentaria formada por fragmentos redondeados de otras rocas inmersas en una arenisca.', '10.50053', '-85.36689', 2,50);
INSERT INTO `site` (`id`, `name`, `qr_url`, `details`, `description`, `latitude`, `longitude`, `district_id`, `points`) VALUES (NULL, 'La Duna', NULL, 'Caminando hacia el Norte unos 50 m.',
 'Esta zona está muy afectada por el viento, que entre diciembre y mayo entra con dirección del Noreste al Suroeste. La arena de la playa se comienza a acumular en un montículo que se denomina “duna costera”.', '10.02691', '-85.43403', 2,50);
...
INSERT INTO `site` (`id`, `name`, `qr_url`, `details`, `description`, `latitude`, `longitude`, `district_id`, `points`) VALUES (NULL, 'El propio Mojón', NULL, 'Muy cerca de la casa de la Policía de Fronteras se puede encontrar el Mojón del Instituto Geográfica.',
 'Este sitio es un punto de importancia geográfica, pues es el indicativo geodésico del límite fronterizo.', '10.04785', '-85.41555', 2,50);
...
INSERT INTO `site` (`id`, `name`, `qr_url`, `details`, `description`, `latitude`, `longitude`, `district_id`, `points`) VALUES (NULL, 'La brecha', NULL, 'Caminando unos 30 m, sobre la carretera, abajo del mirador.',
 'En este sitio se puede observar una brecha. Una brecha  es una roca constituida por fragmentos irregulares de otras rocas, que están dentro de una masa rocosa (matriz) de grano más fino. En este caso todos los fragmentos son volcánicos y se formaron por una gran avalancha o derrumbe de algún antiguo volcán cercano. ', '10.04360', '-85.38178', 2,50);
