...
INSERT INTO `site` (`id`, `name`, `qr_url`, `details`, `description`, `latitude`, `longitude`, `district_id`, `points`) VALUES (NULL, 'La Islita', NULL, 'En el camino del Mirador hacia Junquillal, unos 300 m hay un desvío a la izquierda.',
 'Estas rocas se formaron hace unos 35 millones de años, son muy parecidas a las de la playa 4x4.  Se pueden observar algunos troncos. y espectaculares bioturbaciones destacadas con líneas punteadas y flechas. ', '10.9638889', '-85.69611111111111', 2,50);
...
INSERT INTO `site` (`id`, `name`, `qr_url`, `details`, `description`, `latitude`, `longitude`, `district_id`, `points`) VALUES (NULL, 'La Coyotera', NULL, 'Siguiendo el camino de Junquillal a La Cruz, se desvía a la izquierda hacia el Jobo y luego a la derecha hacia el hotel EcoPlaya.',
 'Esta roca se llama conglomerado. Es una roca sedimentaria formada por fragmentos redondeados de otras rocas inmersas en una arenisca.', '11.0438889', '-85.72305555555556', 2,50);
INSERT INTO `site` (`id`, `name`, `qr_url`, `details`, `description`, `latitude`, `longitude`, `district_id`, `points`) VALUES (NULL, 'La Duna', NULL, 'Caminando hacia el Norte unos 50 m.',
 'Esta zona está muy afectada por el viento, que entre diciembre y mayo entra con dirección del Noreste al Suroeste. La arena de la playa se comienza a acumular en un montículo que se denomina “duna costera”.', '11.0447222', '-85.72333333333333', 2,50);
...
INSERT INTO `site` (`id`, `name`, `qr_url`, `details`, `description`, `latitude`, `longitude`, `district_id`, `points`) VALUES (NULL, 'El propio Mojón', NULL, 'Muy cerca de la casa de la Policía de Fronteras se puede encontrar el Mojón del Instituto Geográfica.',
 'Este sitio es un punto de importancia geográfica, pues es el indicativo geodésico del límite fronterizo.', '11.0797222', '-85.69250000000001', 2,50);
...
INSERT INTO `site` (`id`, `name`, `qr_url`, `details`, `description`, `latitude`, `longitude`, `district_id`, `points`) VALUES (NULL, 'La brecha', NULL, 'Caminando unos 30 m, sobre la carretera, abajo del mirador.',
 'En este sitio se puede observar una brecha. Una brecha  es una roca constituida por fragmentos irregulares de otras rocas, que están dentro de una masa rocosa (matriz) de grano más fino. En este caso todos los fragmentos son volcánicos y se formaron por una gran avalancha o derrumbe de algún antiguo volcán cercano. ', '11.0727778', '-85.63611111111112', 2,50);
...
INSERT INTO `site` (`id`, `name`, `qr_url`, `details`, `description`, `latitude`, `longitude`, `district_id`, `points`) VALUES (NULL, 'La Cueva del Duende', NULL, 'Para visitar este sitio se debe entrar al Parque Santa Rosa y dirigirse a la Casona, ahí se toma el sendero Indio Desnudo. ',
 'Cuando se llega a la quebrada Duende se puede observar La Cueva del Duende, que es un puente natural formado por una capa más resistente en la parte superior, y la capa inferior se erosionó. Se puede observar ambos extremos de la cueva.', '10.8366667', '-85.61138888888888', 2,50);
