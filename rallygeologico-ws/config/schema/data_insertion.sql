...
INSERT INTO `site` (`id`, `name`, `qr_url`, `details`, `description`, `latitude`, `longitude`, `district_id`, `points`) VALUES (NULL, 'El mirador', NULL, 'Este mirador está ubicado en el camino que va de Cuajiniquil a el Parque Nacional Junquillal. Se va a necesitar de su conocimiento adquirido de la brújula. ',
...
INSERT INTO `site` (`id`, `name`, `qr_url`, `details`, `description`, `latitude`, `longitude`, `district_id`, `points`) VALUES (NULL, 'La Islita', NULL, 'En el camino del Mirador hacia Junquillal, unos 300 m hay un desvío a la izquierda.',
 'Estas rocas se formaron hace unos 35 millones de años, son muy parecidas a las de la playa 4x4.  Se pueden observar algunos troncos. y espectaculares bioturbaciones destacadas con líneas punteadas y flechas. ', '10.57833', '-85.41765', 2,50);
INSERT INTO `site` (`id`, `name`, `qr_url`, `details`, `description`, `latitude`, `longitude`, `district_id`, `points`) VALUES (NULL, 'Junquillal', NULL, 'Llegar al sector Junquillal del Área de Conservación Guanacaste y seguir el sendero conocido como Carao. Cuando se llega al punto más alto del sendero estará en en la localidad indicada.',
 'Esta roca es una caliza (roca cuya composición es carbonato de calcio CaCO3), formada por la acumulación de organismos marinos de forma lenticular de alrededor de 1 cm de diámetro (tipo “platillo volador”) en un océano que existió hace unos 40 millones de años. Estos organismos se llaman macroforaminíferos, e internamente sus conchas tienen una estructura interna complicada que se observa en el modelo tridimensional.', '10.58146', '-85.41095', 2,50);
INSERT INTO `site` (`id`, `name`, `qr_url`, `details`, `description`, `latitude`, `longitude`, `district_id`, `points`) VALUES (NULL, 'La Coyotera', NULL, 'Siguiendo el camino de Junquillal a La Cruz, se desvía a la izquierda hacia el Jobo y luego a la derecha hacia el hotel EcoPlaya.',
 'Esta roca se llama conglomerado. Es una roca sedimentaria formada por fragmentos redondeados de otras rocas inmersas en una arenisca.', '11.02638', '-85.43377', 2,50);
INSERT INTO `site` (`id`, `name`, `qr_url`, `details`, `description`, `latitude`, `longitude`, `district_id`, `points`) VALUES (NULL, 'La Duna', NULL, 'Caminando hacia el Norte unos 50 m.',
 'Esta zona está muy afectada por el viento, que entre diciembre y mayo entra con dirección del Noreste al Suroeste. La arena de la playa se comienza a acumular en un montículo que se denomina “duna costera”.', '11.02691', '-85.43403', 2,50);
INSERT INTO `site` (`id`, `name`, `qr_url`, `details`, `description`, `latitude`, `longitude`, `district_id`, `points`) VALUES (NULL, 'El mojón', NULL, 'Para llegar a este sitio se debe tomar un desvío hacia el norte en la cuesta de “La Cortina”, que se ubica al Oeste del poblado de La Cruz. Se pasa el puesto de Policía de Frontera y se baja un camino por 100 m. Se debe tener cuidado de no caminar hacia el Norte, pues se cruza la frontera con Nicaragua.  Se hará uso de la brújula para obtener azimuths.',
 'En este sitio se pueden observar una serie de estratos de roca tipo arenisca fina, dispuesta en numerosas capas, que representan los estratos o eventos durante la depositación de las arenas en un mar relativamente profundo, lo cual ocurrió hace unos 40 millones de años. Los estratos están inclinados hacia el Suroeste, específicamente 210° como se nota con la flecha.  Las líneas amarillas en la imagen muestran las fracturas producidas por las fuerzas de la Tierra. Estas fracturas forman polígonos en las rocas. ', '11.04740', '-85.41507', 2,50);
INSERT INTO `site` (`id`, `name`, `qr_url`, `details`, `description`, `latitude`, `longitude`, `district_id`, `points`) VALUES (NULL, 'El propio Mojón', NULL, 'Muy cerca de la casa de la Policía de Fronteras se puede encontrar el Mojón del Instituto Geográfica.',
 'Este sitio es un punto de importancia geográfica, pues es el indicativo geodésico del límite fronterizo.', '11.04785', '-85.41555', 2,50);
INSERT INTO `site` (`id`, `name`, `qr_url`, `details`, `description`, `latitude`, `longitude`, `district_id`, `points`) VALUES (NULL, 'El mirador', NULL, 'Subiendo la cuesta de La Cortina, hay un mirador de la Municipalidad de La Cruz.',
 'Desde este punto se observa la bahía Salinas, y se observan puntos vistos en otros puntos de este juego. Parte de la razón de esta depresión del terreno que forma la bahía Salinas se debe a que las capas sedimentarias se han doblado (plegado) por las fuerzas de la Tierra y ahora las capas del lado Sur se inclinan hacia el Noreste y las capas del lado Norte se inclinan hacia el Suroeste, formando una cubeta que se llama sinclinal. ', '11.04340', '-85.38210', 2,50);
INSERT INTO `site` (`id`, `name`, `qr_url`, `details`, `description`, `latitude`, `longitude`, `district_id`, `points`) VALUES (NULL, 'La brecha', NULL, 'Caminando unos 30 m, sobre la carretera, abajo del mirador.',
 'En este sitio se puede observar una brecha. Una brecha  es una roca constituida por fragmentos irregulares de otras rocas, que están dentro de una masa rocosa (matriz) de grano más fino. En este caso todos los fragmentos son volcánicos y se formaron por una gran avalancha o derrumbe de algún antiguo volcán cercano. ', '11.04360', '-85.38178', 2,50);

INSERT INTO `site` (`id`, `name`, `qr_url`, `details`, `description`, `latitude`, `longitude`, `district_id`, `points`) VALUES (NULL, 'Volcanes jóvenes y viejos', NULL, 'A la par del camino que se dirige al poblado de Santa Cecilia se puede observar una buena vista del volcán Orosí.',
 'Observando en dirección al Sur se pueden observar 2 estructuras volcánicas. Este es un ejemplo de estructuras volcánicas. Con una dirección Sureste (aproximadamente un azimuth de 140°) está un volcán relativamente reciente que ha tenido actividad hace unos cuantos miles de años y al Sur-Suroeste (aproximadamente 200°) se encuentra una estructura volcánica erosionada que se conoce como el cerro El Hacha, cuya actividad terminó hace unos 2 millones de años. Las rocas que sobresalen del suelo en este sitio probablemente provienen de erupciones de este volcán.', '11.02253', '-85.3274', 2,50);
INSERT INTO `site` (`id`, `name`, `qr_url`, `details`, `description`, `latitude`, `longitude`, `district_id`, `points`) VALUES (NULL, 'Las biotitas de Liberia', NULL, 'Este sitio es a la orilla de la carretera y sería conveniente que lleve una lupa o use una App de lupa en su teléfono.',
 'Esta roca blancuzca y polvorosa, fue producto de una explosiva erupción de un volcán extinto, cuyos productos volcánicos cubrieron una extensa área que va desde Upala, La Cruz y Bagaces, que ocurrió alrededor de 1,5 millones de años. Cuando se observa con una lupa se podrán apreciar unos cristales muy brillantes, que son como láminas y muchas veces hexagonales que se llaman biotita ', '11.02827', '-85.35910', 2,50);
INSERT INTO `site` (`id`, `name`, `qr_url`, `details`, `description`, `latitude`, `longitude`, `district_id`, `points`) VALUES (NULL, 'La Cueva del Duende', NULL, 'Para visitar este sitio se debe entrar al Parque Santa Rosa y dirigirse a la Casona, ahí se toma el sendero Indio Desnudo. ',
 'Cuando se llega a la quebrada Duende se puede observar La Cueva del Duende, que es un puente natural formado por una capa más resistente en la parte superior, y la capa inferior se erosionó. Se puede observar ambos extremos de la cueva.', '11.50204', '-85.36679', 2,50);
INSERT INTO `site` (`id`, `name`, `qr_url`, `details`, `description`, `latitude`, `longitude`, `district_id`, `points`) VALUES (NULL, 'Quebrada Costa Rica', NULL, 'Para llegar a este sitio se debe tomar el camino hacia playa Naranjo, y llegar a la quebrada Costa Rica, ahí se toma el sendero Los Patos.',
 'El sendero lleva a un sitio donde se observa una roca volcánica de una edad mayor a los 2 millones de años. Cuando se observa con atención se puede observar unos componentes alargados que se llaman fiammes, y que son fragmentos de vidrio volcánico. También se observan unos huecos formados por la erosión, que se llaman marmitas de erosión. Estas estructuras se forman por la erosión de algunos fragmentos de roca que raspan los huecos esféricos y los van haciendo poco a poco más grandes. ', '10.49647', '-85.38188', 2,50);
INSERT INTO `site` (`id`, `name`, `qr_url`, `details`, `description`, `latitude`, `longitude`, `district_id`, `points`) VALUES (NULL, 'Las columnas de Carbonal', NULL, 'Continuando sobre el camino a playa Naranjo.',
 'Cuando algunas lavas se enfrían producen un sistema de fracturas en forma de columnas. Estas fracturas se forman por la contracción del material lávico al enfriar, y son idealmente en forma de hexágonos, aunque generalmente son un poco más irregulares.', '10.47893', '-85.38501', 2, 50);

INSERT INTO `rally` (`id`, `name`, `points_awarded`, `image_url`, `description`, `latitude`, `longitude`) VALUES (NULL, 'Rally 1', '500', NULL, 'El Rally #1 incluye localidades en sitios del cantón de La Cruz como: El parque nacional Santa Rosa, con increíbles paisajes naturales declarados patrimonio de la humanidad; y Cuajiniquil, pueblo costero cuya principal actividad económica es la pesca y el creciente desarrollo turístico. En este rally se conocerán rocas volcánicas generadas en las profundidades oceánicas, así como rocas sedimentarias consecuencia de eventos meteorológicos fosilizados, conocidas por los geólogos como tormentitas, y algunas rocas producto de erupciones volcánicas explosivas.', '10.50053', '-85.36689');
