package cr.ac.ucr.cicg.clavicusoft.rallygeologico.support.dao.impl;
...
public abstract class HibernateCrudDao<ModelObjectType extends BasicEntity, KeyType extends Serializable> {
    ...
    /**
     * @see cr.ac.ucr.cicg.clavicusoft.rallygeologico.support.dao.CrudDao#create(BasicEntity)
     */
    ...
    /**
     * @see cr.ac.ucr.cicg.clavicusoft.rallygeologico.support.dao.CrudDao#update(BasicEntity)
     */
    ...
    /**
     * @see cr.ac.ucr.cicg.clavicusoft.rallygeologico.support.dao.CrudDao(BasicEntity)
     */
    ...
    /**
     * @see cr.ac.ucr.cicg.clavicusoft.rallygeologico.support.dao.CrudDao#findById(Object)
     */
    @SuppressWarnings("unchecked")
